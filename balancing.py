...
START_GOLD = 500       # Player's initial gold amount (where do they earn more?)
START_LIVES = 10       # Player's initial number of Lives   
...
T1_RAN = 1   # Tower 1 Range  
T1_SPD = 5   # Tower 1 Speed

T2_VAL = 200 # Tower 2 Cost
T2_DAM = 25  # Tower 2 Damage
T2_RAN = 2   # Tower 2 Range  
...
E1_HP = 100  # Enemy 1 Health
E1_SPD = 1  # Enemy 1 Speed

E2_HP = 75  # Enemy 2 Health
E2_SPD = 2  # Enemy 2 Speed

E3_HP = 100  # Enemy 3 Health
